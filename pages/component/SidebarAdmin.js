    ...
    return (
        <Sider trigger={null} collapsible collapsed={collapse.getCollapse} className="sidebarLayout" width={250} >
            ...
            <Menu className='menuSidebar' mode="inline" defaultSelectedKeys={[router.pathname]}>
                <Menu.Item className='subMenuSidebar' key="/admin/home" icon={<span className="iconify svgIcon" data-icon="fa-solid:home" data-inline="false"></span>} onClick={() => {
                    router.push('/admin/home')
                }}>
                    <span className="textMenu">Home</span>
                </Menu.Item>
                <Menu.Item className='subMenuSidebar' key="/admin/leaveManagement" icon={<span className="iconify svgIcon" data-icon="clarity:tasks-solid" data-inline="false"></span>} onClick={() => {
                    router.push('/admin/leaveManagement')
                }}>
                    <span className="textMenu">Leavemanagement</span>
                </Menu.Item>
                <Menu.Item className='subMenuSidebar' key="/admin/userManagement" icon={<span className="iconify svgIcon" data-icon="ic:baseline-manage-accounts" data-inline="false"></span>} onClick={() => {
                    router.push('/admin/userManagement')
                }}>
                    <span className="textMenu">Usermanagement</span>
                </Menu.Item>
                <Menu.Item className='subMenuSidebar' key="/admin/activity" icon={<span className="iconify svgIcon" data-icon="tabler:report" data-inline="false"></span>} onClick={() => {
                    router.push('/admin/activity')
                }}>
                    <span className="textMenu">Activity</span>
                </Menu.Item>
                <Menu.Item className='subMenuSidebar' key="/admin/profile" icon={<span className="iconify svgIcon" data-icon="carbon:user-avatar-filled" data-inline="false"></span>} onClick={() => {
